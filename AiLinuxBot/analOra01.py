### FUNCIONA OK; pero no entiendo las siglas que analizaj jajaj 
# python3 y en castellano.
# Objetivo: permite etiquetar funciones sintacticas de las palabras
#	de una oracion. Muy util para interpretar lenguaje
#################################################################
...
print(tagger.uni.tag(oracion.split()))
print("=================================")
for pal,func in tagger.uni.tag(oracion.split()):
	print(func)
