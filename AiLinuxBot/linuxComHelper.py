...
def grabarLog(registro):
	...
	# abrimos archivo
	logFile = open("/home/pi/python/AiLinuxBot/logs/logChat.txt","a")
...
def isGreetings(pregunta):
	saludos = open("/home/pi/python/AiLinuxBot/greetings/greetings.txt","r")
...
def getSinonimo(pal):
	listSin = []
	archSin = open("/home/pi/python/AiLinuxBot/synonym/synonym.txt","r")
	for reg1 in archSin:
		# suprimimos el enter
		reg = reg1.strip('\n')
		if (reg.find(pal) > -1):
...
if __name__ == '__main__':
	...
	#cargarCorpus()
	directorio = "/home/pi/python/AiLinuxBot/linuxCorpus"
